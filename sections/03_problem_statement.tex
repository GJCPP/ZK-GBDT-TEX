...
total-sum expressions over the bin axis.
Our proof thus follows by committing the statistics,
proving its prefix and suffix sums,
computing RSS for all possible splits,
and finally prove that the optimal ones are chosen and applied.
