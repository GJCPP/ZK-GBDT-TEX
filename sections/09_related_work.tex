...
data-parallel circuits and apply it to
...
\subsection{Batching Lookup Arguments}\label{subsec:related-lookup-batching}
...
To the best of our knowledge, this type of batching
...
In our construction, we use the matrix lookup of~\cite{cq++24},
