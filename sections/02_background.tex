...
\mathbf{Y}[r,k]\log \boldsymbol{\pi}[t,k,r].
\end{equation}
...
=
\boldsymbol{\pi}[t,k,r]-\mathbf{Y}[r,k].
\end{equation}
...
-\frac{\partial \mathcal{L}^{(t)}}{\partial \mathbf{S}[t,k,r]}
=
\mathbf{Y}[r,k]-\boldsymbol{\pi}[t,k,r],
\qquad t<T-1.
\end{equation}
The initial target is set as $\mathbf{G}[0,k,r]=\mathbf{Y}[r,k]$. We call
...
\begin{itemize}
    ...
    and proves that the forest is obtained by honestly running the public quantized trainer on the committed dataset.
