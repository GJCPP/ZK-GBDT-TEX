...
\subsection{Threat Model and Security Goal}\label{subsec:threat-model-security-goal}
...
(ill-formed) forest or claim an incorrect inference output, and it may try to convince the
...
\begin{enumerate}
    ...
    \item \textbf{(Optional) Zero-knowledge.} 
