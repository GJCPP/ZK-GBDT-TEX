...
Finally, the proof of leaf output (which can be a majority label or class-frequency vector)
can be handled by committing the output as a (one-hot or probability) vector and proving its correctness with a maximum or argmax proof.
