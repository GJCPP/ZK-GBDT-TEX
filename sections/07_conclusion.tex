...
By committing the training trace as structured tensors, \textsc{Terrae} proves the correctness of training and inference without relying on proving the correctness of circuits.
Our main technical
...
prover cost compared to a circuit-style baseline.
